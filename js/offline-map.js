                ...
                return `<div class="film-list-land">
                          <div class="film-out">
                            <div class="film-thumb">
                                <img src="${film[0].picture}" alt="${film[0].name} Movie Poster"/>
                            </div>
                            <div class="film-times">
                                ...
                                <table>
                                  <tr>
                                    <th>3D</th>
                                    <td>${film[0].times.td[0]}</td>
                                    <td>${film[0].times.td[1]}</td>
                                    <td>${film[0].times.td[2]}</td>
                                    <td>${film[0].times.td[3]}</td>
                                    <td>${film[0].times.td[4]}</td>
                                  </tr>
                                  <tr>
                                    <th>Standard</th>
                                    <td>${film[0].times.standard[0]}</td>
                                    <td>${film[0].times.standard[1]}</td>
                                    <td>${film[0].times.standard[2]}</td>
                                    <td>${film[0].times.standard[3]}</td>
                                    <td>${film[0].times.standard[4]}</td>
                                  </tr>
                                </table>
                                </div>
                              </div>
